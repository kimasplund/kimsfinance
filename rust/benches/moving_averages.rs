...
use kimsfinance_core::indicators::{Indicator, SMA, EMA, WMA, VWMA, DEMA, TEMA, HMA};
...
fn benchmark_sma(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                sma.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
...
fn benchmark_ema(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                ema.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
...
fn benchmark_wma(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                wma.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
...
fn benchmark_vwma(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                vwma.calculate_with_volume(black_box(prices.view()), black_box(volumes.view())).unwrap()
            });
        });
    }
...
fn benchmark_dema(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                dema.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
...
fn benchmark_tema(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                tema.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
...
fn benchmark_hma(c: &mut Criterion) {
    ...
    for size in [100, 500, 1000, 5000, 10000].iter() {
        ...
        group.bench_with_input(BenchmarkId::from_parameter(size), size, |b, &_size| {
            b.iter(|| {
                hma.calculate(black_box(prices.view())).unwrap()
            });
        });
    }
