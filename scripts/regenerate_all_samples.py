...
def regenerate_api_native_tests():
    ...
    for filename, chart_type in configs:
        ...
        try:
            if chart_type == 'renko':
                plot(df, type=chart_type, volume=True, box_size=2.0,
                     savefig=str(output_path), width=800, height=600)
            elif chart_type == 'pnf':
                plot(df, type=chart_type, volume=True, box_size=2.0, reversal_boxes=3,
                     savefig=str(output_path), width=800, height=600)
            else:
                plot(df, type=chart_type, volume=True,
                     savefig=str(output_path), width=800, height=600)
...
def regenerate_tick_chart_samples():
    ...
    for tick_size in tick_sizes:
        ...
        plot(ohlc, type='candle', volume=True,
             savefig=str(output_path), width=1920, height=1080)
    ...
    for chart_type in chart_types:
        ...
        try:
            plot(ohlc, type=chart_type, volume=True,
                 savefig=str(output_path), width=1600, height=900)
...
def regenerate_volume_chart_samples():
    ...
    for volume_size in volume_sizes:
        ...
        plot(ohlc, type='hollow_and_filled', volume=True,
             savefig=str(output_path), width=1920, height=1080)
...
def regenerate_range_chart_samples():
    ...
    for range_size in range_sizes:
        ...
        plot(ohlc, type='ohlc', volume=True,
             savefig=str(output_path), width=1920, height=1080)
...
def regenerate_comparison_charts():
    ...
    for filename, ohlc_data, title in configs:
        ...
        plot(ohlc_data, type='candle', volume=True,
             savefig=str(output_path), width=1600, height=900)
...
def regenerate_theme_samples():
    ...
    for theme in themes:
        ...
        plot(df, type='candle', style=theme, volume=True,
             savefig=str(output_path), width=1600, height=900)
...
def regenerate_indicator_samples():
    ...
    plot(df_rsi, type='candle', volume=True,
         savefig=str(output_path), width=1920, height=1080)
    ...
    plot(df, type='candle', volume=True,
         savefig=str(output_path), width=1920, height=1080)
