...
def run_simulation():
    ...
    for current_time in all_timestamps:
        ...
        for ticker, df in dfs.items():
            ...
            if pos is not None:
                ...
                if low <= pos['stop_loss']:
                    ...
                    trades.append({
                        ...
                        'Result': result, 'Gross_PnL': pos['gross_pnl'], 'Fees': pos['fees'], 'Net_PnL': net_pnl,
                        'Entry': pos['entry_price']
                    })
                    
                    open_positions[ticker] = None
                    if daily_pnl_R <= -3.0:
                        if not daily_limit_hit: limit_hit_count += 1
                ...
                # Check Target 2 (Runner Target)
                    ...
                    trades.append({
                        'Ticker': ticker, 'Skill': pos['skill'], 
                        'Result': 'Win', 'Gross_PnL': pos['gross_pnl'], 'Fees': pos['fees'], 'Net_PnL': net_pnl,
                        'Entry': pos['entry_price']
                    })
                    open_positions[ticker] = None
            ...
            # EMA Bounce Setup
            elif prev_row['High'] > prev_row['EMA_20'] and prev_row['Low'] <= prev_row['EMA_20'] and prev_row['Close'] > prev_row['Open']:
    ...
    with open(report_path, "w") as f:
        ...
        f.write("This simulation explicitly models Binance Futures Maker/Taker fees (0.018%/0.045%) and 10x Buying Power limitations.\n\n")
        ...
        f.write(f"### Strategy Performance Breakdown\n")
