...
def run_simulation(params):
    ...
    for current_time in all_timestamps:
        ...
        for ticker, df in local_dfs.items():
            ...
            # Trend Filter
            is_trending_up = (
                prev_row["EMA_Trend_Slope"] > 0 and prev_row["EMA_Trend"] > prev_row["EMA_50"]
            )
...
if __name__ == "__main__":
    ...
    print(
        f"Best Performance: {best['total_r']:.2f}R (+${best['final_capital'] - 10000:.2f}) over {best['trades']} trades."
    )
