...
mpf.plot(df_display, **base_config, addplot=apds,
         panel_ratios=(3, 1, 1),
...
k_fast, d_fast = calculate_stochastic(df_display['High'], df_display['Low'], df_display['Close'], 5, 3)
...
mpf.plot(df_display, **dashboard_config, addplot=apds,
