...
def test_render_ohlc_bars_all_themes():
    ...
    for theme_name in THEMES.keys():
        img = render_ohlc_bars(SAMPLE_OHLC, SAMPLE_VOLUME, theme=theme_name, width=800, height=600)
...
def test_render_ohlc_bars_rgb_mode():
    ...
    img = render_ohlc_bars(
        SAMPLE_OHLC, SAMPLE_VOLUME, width=800, height=600, enable_antialiasing=False
    )
...
def test_render_ohlc_bars_no_grid():
    ...
    """
    img = render_ohlc_bars(SAMPLE_OHLC, SAMPLE_VOLUME, width=800, height=600, show_grid=False)
...
def test_render_ohlc_bars_small_dimensions():
    ...
    """
    img = render_ohlc_bars(SAMPLE_OHLC, SAMPLE_VOLUME, width=400, height=300)
...
def test_render_ohlc_bars_large_dimensions():
    ...
    """
    img = render_ohlc_bars(SAMPLE_OHLC, SAMPLE_VOLUME, width=3840, height=2160)
