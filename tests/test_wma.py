...
class TestWMABasic:
    ...
    def test_basic_calculation(self, sample_data):
        ...
        result = calculate_wma(sample_data, period=20, engine='cpu')
    ...
    def test_different_periods(self, sample_data):
        ...
        # Test period=10
        result_10 = calculate_wma(sample_data, period=10, engine='cpu')

        # Test period=50
        result_50 = calculate_wma(sample_data, period=50, engine='cpu')
    ...
    def test_wma_more_responsive_than_sma(self, sample_data):
        ...
        wma = calculate_wma(test_data, period=20, engine='cpu')
        sma = calculate_sma(test_data, period=20, engine='cpu')
...
class TestWMAGPUCPU:
    ...
    def test_gpu_cpu_match_small_data(self, sample_data):
        ...
        # CPU calculation
        cpu_result = calculate_wma(sample_data, period=20, engine='cpu')

        # GPU calculation (may fallback to CPU if GPU not available)
        gpu_result = calculate_wma(sample_data, period=20, engine='gpu')
    ...
    def test_gpu_cpu_match_large_data(self, large_data):
        ...
        # CPU calculation
        cpu_result = calculate_wma(large_data, period=20, engine='cpu')

        # GPU calculation
        gpu_result = calculate_wma(large_data, period=20, engine='gpu')
    ...
    def test_auto_engine_selection(self, large_data):
        ...
        auto_result = calculate_wma(large_data, period=20, engine='auto')
...
class TestWMAAlgorithm:
    ...
    def test_constant_prices_converge_to_constant(self):
        ...
        result = calculate_wma(data, period=10, engine='cpu')
...
class TestWMAEdgeCases:
    ...
    def test_invalid_period_raises_error(self, sample_data):
        ...
        with pytest.raises(ValueError, match="period must be >= 1"):
            calculate_wma(sample_data, period=0)

        with pytest.raises(ValueError, match="period must be >= 1"):
            calculate_wma(sample_data, period=-5)
    ...
    def test_insufficient_data_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Insufficient data"):
            calculate_wma(short_data, period=20)
    ...
    def test_minimal_data_size(self):
        ...
        result = calculate_wma(data, period=period, engine='cpu')
    ...
    def test_handles_list_input(self):
        ...
        result = calculate_wma(prices, period=10, engine='cpu')
    ...
    def test_single_period(self, sample_data):
        ...
        result = calculate_wma(sample_data, period=1, engine='cpu')
...
class TestWMAAPI:
    ...
    def test_invalid_engine_raises_error(self, sample_data):
        ...
        with pytest.raises(ValueError, match="Invalid engine"):
            calculate_wma(sample_data, engine='invalid')
...
class TestWMAPerformance:
    ...
    def test_completes_in_reasonable_time_large_data(self, large_data):
        ...
        start = time.time()
        result = calculate_wma(large_data, period=20, engine='cpu')
        elapsed = time.time() - start
