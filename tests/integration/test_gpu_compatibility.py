...
def test_gpu_available_constant():
    ...
    assert GPU_AVAILABLE == info['gpu_available'], \
...
class TestCPUFallback:
    ...
    def test_cpu_mode_works(self):
        ...
        optimizer = GeneticOptimizer(
            param_space={'period': (10, 20, int), 'buy_threshold': (25.0, 35.0, float), 'sell_threshold': (65.0, 75.0, float)},
            population_size=10,
            generations=2
        )
    ...
    def test_cpu_vs_gpu_same_results(self):
        ...
        optimizer = GeneticOptimizer(
            param_space={'period': (14, 14, int), 'buy_threshold': (30.0, 30.0, float), 'sell_threshold': (70.0, 70.0, float)},
            population_size=1,
            generations=1
        )
...
class TestGracefulDegradation:
    ...
    def test_fallback_on_gpu_error(self):
        ...
        optimizer = GeneticOptimizer(
            param_space={'period': (10, 15, int), 'buy_threshold': (28.0, 32.0, float), 'sell_threshold': (68.0, 72.0, float)},
            population_size=5,
            generations=2
        )
